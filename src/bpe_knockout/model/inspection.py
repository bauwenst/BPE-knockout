...
class BPEKnockoutVocabulariser_NoTrivialKnockout(BPEKnockoutVocabulariser):
    ...
    """
    def __init__(self, initial_tokeniser: BPE_Artifacts, config: BTEConfig, long_part_threshold: int, holdout: Holdout, iteration_evaluator: IntermediateEvaluator, quiet: bool=True):
