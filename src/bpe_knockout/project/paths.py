...
IS_INSIDE_PROJECT = PATH_CWD.is_relative_to(PATH_PACKAGE)
assert not(IS_INSIDE_PROJECT and not IS_EDITABLE_INSTALL)
...
# Data not delivered with the package by default.
