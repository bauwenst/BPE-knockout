...
from .preprocess_util import get_tokenizer, write_sequence_word_label, get_sequence_file_paths
...
def process_connl2002_ner(arguments, type, processed_data_path, raw_data_path):
    output_sentences_path, output_labels_path, output_tokenized_sentences_path, output_tokenized_labels_path = get_sequence_file_paths(
        processed_data_path, type)
    tokenizer = get_tokenizer(arguments)
                    ...
                    with open(file_path) as file_to_read:
                        ...
                        for line in file_to_read:
                            if not line.startswith("-DOCSTART-") and len(line.strip()) > 0:
                                ...
                                write_sequence_word_label(word, label, tokenizer, output_sentences,
                                                                          output_labels,
