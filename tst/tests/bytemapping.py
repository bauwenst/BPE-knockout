...
from bpe_knockout.model.vocabulariser import BTE, FullBPEKnockoutConfig, ReferenceMode
...
def compareWithAndWithoutByteRemapping():
    ...
    bte1 = BTE(FullBPEKnockoutConfig(bytebased=ByteBasedMode.NONE, knockout=ReferenceMode.ALL), execution_policy=ExecutionPolicy.POSTPONED)
    bte2 = BTE(FullBPEKnockoutConfig(bytebased=ByteBasedMode.VOCAB_TO_CHARS, knockout=ReferenceMode.ALL), execution_policy=ExecutionPolicy.POSTPONED)
    ...
    bte1 = BTE(FullBPEKnockoutConfig(bytebased=ByteBasedMode.NONE, knockout=ReferenceMode.ALL), execution_policy=ExecutionPolicy.IMMEDIATE)
    bte2 = BTE(FullBPEKnockoutConfig(bytebased=ByteBasedMode.VOCAB_TO_CHARS, knockout=ReferenceMode.ALL), execution_policy=ExecutionPolicy.IMMEDIATE)
    assert_tokenisers_equal(bte1, bte2)
